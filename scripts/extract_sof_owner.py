"""Extract owner SOF events from fixture PDF. Run once, commit the result.

Usage:
  export $(cat .env | xargs)
  uv run --directory apps/api python ../../scripts/extract_sof_owner.py
"""
...
out = FIXTURE_DIR / "extracted_sof_owner.json"
